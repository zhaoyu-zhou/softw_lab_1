...
class TextProcessorTest {
    ...
    @Test
    void testCalcShortestPath_BothWordsExistWithPath() {
        String input = "word1\nword2\n";
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        Scanner scanner = new Scanner(System.in);
        ...
        TextProcessor.calcShortestPath(scanner, graph);

        String output = outContent.toString().trim();
        String[] lines = output.split("\n");
        String lastLine = lines[lines.length - 1].trim();

        String expectedOutput = "最短路径：\nword1 word2";
        System.out.println("Expected Output: " + expectedOutput);
        System.out.println("Actual Output: " + lastLine);
        assertEquals(expectedOutput, lastLine);

    }

    @Test
    void testCalcShortestPath_BothWordsExistWithoutPath() {
        String input = "word1\nword3\n";
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        Scanner scanner = new Scanner(System.in);
        ...
        String output = outContent.toString().trim();
        String expectedOutput = "起始单词到目标单词之间无最短路径。";
        System.out.println("Expected Output: " + expectedOutput);
    ...
    @Test
    void testCalcShortestPath_StartWordNotExist() {
        String input = "nonexistent\nword2\n";
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        Scanner scanner = new Scanner(System.in);
    ...
    @Test
    void testCalcShortestPath_TargetWordNotExist() {
        String input = "word1\nnonexistent\n";
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        Scanner scanner = new Scanner(System.in);
